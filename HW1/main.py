...
#initialize neuralnet
nn = NeuralNetwork(layers, learning_rate, mini_batch_size, epochs, matmul=matmul_numba)
...
#initialize neuralnet
nn = NeuralNetwork(layers, learning_rate, mini_batch_size, epochs, matmul=matmul_gpu)
